...
define([
  ...
  var CuratedTagView = Backbone.View.extend({
    ...
    render: function() {
      var tagsTemplate, that = this, collectionJSON = this.collection.toJSON();
      //console.log(JSON.stringify(collectionJSON, undefined, 2));

      //var categoriesJSON = this.options.categories.toJSON();
      //console.log(JSON.stringify(categoriesJSON, undefined, 2));
